...
use bevy::prelude::*;
use bevy_egui::{egui::{self, DragValue, Color32, TextStyle}, EguiContext};
use egui_node_graph::*;
...
impl Default for MyNodeTemplate {
    fn default() -> Self {
        Self::MakeVector
    }
}
...
impl NodeTemplateTrait for MyNodeTemplate {
    ...
    fn node_finder_label(&self, _user_state: &mut MyGraphState) -> Cow<str> {
    ...
    fn node_graph_label(&self, user_state: &mut MyGraphState) -> String {
        // It's okay to delegate this to node_finder_label if you don't want to
        // show different names in the node finder and the node itself.
        self.node_finder_label(user_state).into()
    }

    fn user_data(&self, _user_state: &mut MyGraphState) -> Self::NodeData {
